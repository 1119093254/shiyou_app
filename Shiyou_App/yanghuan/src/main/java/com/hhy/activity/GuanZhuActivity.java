...
public class GuanZhuActivity extends AppCompatActivity {
    ...
    private void setListener() {
        ...
        mPullToRefreshListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(GuanZhuActivity.this,OtherInfoActivity.class);
    ...
    private void initView() {
        ...
        mPullToRefreshListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(GuanZhuActivity.this, "123", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void initData() {
        ...
        GuanZhu guanZhu1 = new GuanZhu(0, "酷宝宝有时很任性", "手一残100首歌就没了", "http://img3.imgtn.bdimg.com/it/u=2165175176,3806470859&fm=21&gp=0.jpg", 0, false);
        GuanZhu guanZhu2 = new GuanZhu(1, "酷宝宝有时很任性", "手一残100首歌就没了", "http://img3.imgtn.bdimg.com/it/u=2165175176,3806470859&fm=21&gp=0.jpg", 1, false);
        mList.add(guanZhu1);
        mList.add(guanZhu2);
        selectDataBase();
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                for (int i = 0; i < lists.size(); i++) {
                    ...
                    Toast.makeText(GuanZhuActivity.this, userInfo.toString(), Toast.LENGTH_SHORT).show();
                    guanZhu = new GuanZhu(userInfo.getUid(), userInfo.getUname(), userInfo.getUsign(), userInfo.getUrl(), 2, true);
                    mList.add(guanZhu);
                }
                setAdapter();
