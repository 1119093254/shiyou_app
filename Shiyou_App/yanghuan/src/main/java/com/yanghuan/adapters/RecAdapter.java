...
import com.yanghuan.MyApplication.DianShiActivity;
import com.yanghuan.MyApplication.DinYingActivity;
import com.yanghuan.R;
import com.yanghuan.Utils.RecommendBean;
       ...
       viewHolder.imageView2.setOnClickListener(new View.OnClickListener() {
        ...
        viewHolder.imageView5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (position){
                    case 0:
                        Intent intent = new Intent(mContext,DianShiActivity.class);
                        intent.putExtra("1","RecAdapter");
                        mContext.startActivity(intent);
                        break;
                    case 1:
                        Intent intent1=new Intent(mContext,DinYingActivity.class);
