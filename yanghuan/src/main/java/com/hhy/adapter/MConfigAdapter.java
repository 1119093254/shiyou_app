...
public class MConfigAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (type == TYPE_1) {
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.item_config1, null);
            ...
            if (convertView == null) {
                ...
                convertView = mInflater.inflate(R.layout.item_config2, null);
            ...
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.item_config3, null);
